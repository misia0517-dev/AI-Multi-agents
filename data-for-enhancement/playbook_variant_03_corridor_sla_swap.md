...
|---|---|---|---|---|---|
| C1_I95_NJ_BOS | NJ -> Boston (I-95) | Newark_NJ_DC | Boston_MA | Tier 2 | Variant: Boston corridor lowered to Tier 2 for priority testing |
| C2_NJ_PHL | NJ -> Philadelphia | Newark_NJ_DC | Philadelphia_PA | Tier 1 | Variant: Philadelphia corridor raised to Tier 1 for priority testing |
